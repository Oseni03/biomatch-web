		...
		>
			...
			{req.status !== "completed" && (
				<div className="grid grid-cols-3 gap-4 p-4 bg-muted border-border rounded-2xl mb-6">
					...
					<div className="text-center md:border-r border-border">
						<span className="text-[22px] font-bold font-mono text-status-ok block">
							{funnel.accepted}
						</span>
						<span className="text-[9px] font-mono uppercase text-muted-foreground tracking-wider">
							Matches Found
			...
			{req.status === "matched" && funnel.donorName && (
				<div className="p-4 bg-status-ok-bg border border-status-ok/20 rounded-2xl mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
					<div className="flex items-center gap-3">
						<div className="w-10 h-10 bg-status-ok-bg rounded-xl flex items-center justify-center text-status-ok">
							<Clock className="h-5 w-5 animate-spin" />
						</div>
						<div>
							<span className="text-[10px] font-mono uppercase text-status-ok font-semibold block">
								Donor En Route
							</span>
					...
					<div className="text-right w-full md:w-auto flex flex-col md:items-end gap-2">
						<span className="text-xs font-mono text-muted-foreground uppercase">
							...
							<strong className="text-status-ok font-bold">
								{funnel.eta} mins
							</strong>
						</span>
						...
						<Button
							...
							className="bg-status-ok text-white shadow hover:bg-status-ok hover:opacity-90 hover:scale-100"
						>
